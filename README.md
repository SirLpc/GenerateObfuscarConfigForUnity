...
# Notice
You should pay attention to those name sensitve members in your class, such as a method will used by unity delay Invoke("NameOfMethod"). At this point, you could create a custom attribule to mark a method should not be renamed, and config this attribute in the `ObfuscarModuleIgnoreAttributes` array in the scriptable object config before.
